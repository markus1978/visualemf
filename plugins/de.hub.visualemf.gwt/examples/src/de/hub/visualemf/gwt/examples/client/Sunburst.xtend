 ...
 "children": [
  ...
  },
  {
   ...
   "children": [
	...
	@JsNative private def JavaScriptObject create(Element element, JavaScriptObject data, String css) '''
		var d3 = $wnd.d3;
		...
		//d3.select(element).style("height", height + "px");
	'''
	
	def render() {
		create(this.element, data, css.chart)
	}
}